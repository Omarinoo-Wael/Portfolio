...
function RoundProgressBar({ percentage, skill }) {
    ...
    const strokeDashoffset = (strokeDasharray - (percentage / 100) * strokeDasharray) +margin;
            ...
            <svg width="200" height="200" viewBox="0 0 200 200 "className='skill'>
                <defs>
                    <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stop-color="#020a13" />   
                        <stop offset="40%" stop-color="#0a4d8c" />  
                        <stop offset="100%" stop-color="#2d94d4" />
                    </linearGradient>
                </defs>
                ...
                <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" 
                    fill="aliceblue" fontSize="30px" fontWeight="bold">
                    {percentage}%
                </text>
